<%@ Page Title="" Language="C#" MasterPageFile="~/Subscriber.Master" AutoEventWireup="true" CodeBehind="SubscriberChangePassword.aspx.cs" Inherits="PublisherSubcriberNotification.SubscriberChangePassword" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtConPassword" class="form-control" runat="server" 
                                        TextMode="Password"></asp:TextBox>
